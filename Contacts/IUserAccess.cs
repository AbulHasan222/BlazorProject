using FintechHub.UI.Components.Pages;
using FintechHub.UI.Models.Entity;

namespace FintechHub.UI.Contacts
{
    public interface IUserAccess
    {
        public List<UserAccessInfo> GET_USER_ACCESS_LIST(string UserId, string AppId, string ItemType, float HOUserPermission);
